...
// However, just as she finished rating all exhibitions, she's off to an important fair, so she asks you to write a program that tells her the ratings of the items after 
...
function removeSmallest(numbers) {
    ...
    copyArray.splice(numbers.indexOf(Math.min(...numbers)), 1)
    return copyArray
}